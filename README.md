...
**Pinned**
- [`behavior-triggered-outreach-engine`](https://github.com/jakob-prince/behavior-triggered-outreach-engine) — a reference implementation of a behavior-triggered, AI-personalized PLG outreach engine (detect → score → cohort → draft → enroll). Synthetic data; AI + CRM behind swappable interfaces.
